    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex flex-col items-center leading-none">
          <span className="font-serif text-2xl tracking-[0.3em] text-charcoal font-bold">
            SNACKS
          </span>
          <span className="text-charcoal text-xs tracking-[0.5em] -mt-1">&amp;</span>
          <span className="font-serif text-2xl tracking-[0.3em] text-charcoal font-bold -mt-1">
            SIPS
          </span>
        </Link>
      ...
      >
        <div className="bg-cream/98 backdrop-blur-md border-t border-gold/20 px-6 py-6 flex flex-col gap-4">
          {links.map((link) => (
            <Link
              key={link.href}
              href={link.href}
